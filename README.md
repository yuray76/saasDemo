...
## 0. Undeploy звичайного SAPUI5 застосунку
Якщо додаток розгорнутий у субакаунті, то потрібно перейти в Application Info та виконати Undeploy

![Application Info](./screens/00.png)
